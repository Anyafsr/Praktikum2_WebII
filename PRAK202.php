...
<body>
    <form method="post">
        ...
        <input type="radio" name="jenisk" value="Laki-Laki" <?php 
        
        if (isset($_POST["jenisk"]) && $_POST["jenisk"] == "Laki-Laki") echo "checked";?> >Laki-Laki</br>
        <input type="radio" name="jenisk" value="Perempuan"<?php
        if (isset($_POST["jenisk"]) && $_POST["jenisk"] == "Perempuan") echo "checked";?> >Perempuan</br>
        <input type="submit" name="submit" value="Submit"></form></br><?php
